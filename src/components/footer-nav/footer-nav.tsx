        ...
        <div class="grid lg:rounded-md place-items-center text-slate-800 bg-zinc-200">
          <div class="flex flex-col-reverse w-full max-w-6xl gap-16 p-4 mt-4 mb-8 lg:flex-row">
            <div class="flex flex-col gap-2">
              ...
              <span>
                Example of using <code>stencil-tailwind-plugin</code>
              </span>
              <span>
                Website inspiration taken from <Link to="https://daisyui.com/">daisyUI</Link>
              </span>
            </div>
            <div class="flex flex-col">
              <span class="mb-2 font-bold uppercase opacity-50">Links</span>
              <ul class="flex flex-col gap-2 lg:gap-4">
                <Link to="https://github.com/Poimen/stencil-tailwind-plugin-example">
                  This Example Repository
                </Link>
                <Link to="https://github.com/Poimen/stencil-tailwind-plugin">
